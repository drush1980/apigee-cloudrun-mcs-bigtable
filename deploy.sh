...
echo "curl -XPOST $REMOTE_TOKEN_URL -H 'Content-Type: application/json' -d '{\"client_id\": \"$CLIENT_ID\",\"client_secret\": \"$CLIENT_SECRET\",\"grant_type\": \"client_credentials\"}'"
echo " "
echo "To export the Cloud Run domain:"
echo "export RUN_DOMAIN=$RUN_DOMAIN"
echo " "
